...
public static class ChatTools
{
    ...
    public static async Task<string> GetTopdesk(string query, IRagDatabaseService ragDatabaseService)
    {
        RagProject? ragProject = await ragDatabaseService.GetRagProjectByName("TopdeskKnowledgeItems");
        var ragSearchResult = await ragDatabaseService.DoGenericRagSearch(ragProject, query);
    ...
    public static async Task<string> HandleToolCall(ChatToolCall toolCall, IRagDatabaseService? ragDatabaseService = null)
    {
        try
        {
            ...
            switch (toolCall.FunctionName)
            {
                case "getTopdesk":
                    ...
                    else
                    {
                        ...
                        return await GetTopdesk(query, ragDatabaseService);
                    }
