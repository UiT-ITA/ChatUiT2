...
public class SettingsService : ISettingsService
{
    ...
    public ModelName MapModelName(string modelName)
    {
        return modelName switch
        {
            ...
            "gpt-4.1" => ModelName.gpt_41,
            "gpt-4.1-mini" => ModelName.gpt_41_mini,
            "gpt-4.1-nano" => ModelName.gpt_41_nano,
            "gpt-4.5" => ModelName.gpt_45,
            "gpt-5" => ModelName.gpt_5,
            "gpt-5-chat" => ModelName.gpt_5_chat,
            "gpt-5-mini" => ModelName.gpt_5_mini,
            "gpt-5-nano" => ModelName.gpt_5_nano,
            "o1" => ModelName.o1,
            "o1-mini" => ModelName.o1_mini,
            "o3" => ModelName.o3,
            "o3-low" => ModelName.o3_low,
            "o3-medium" => ModelName.o3_medium,
            "o3-high" => ModelName.o3_high,
